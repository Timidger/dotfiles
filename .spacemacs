...
you should place your code here."
  ...
  (setq flycheck-global-modes '(go-mode yaml-mode json-mode js2-mode coffee-mode python-mode web-mode slim-mode scss-mode sass-mode pug-mode less-mode haml-mode rust-mode lua-mode markdown-mode))
  ...
  (linum-mode)
  (setq racer-rustc-src-path "~/.rust/src")
